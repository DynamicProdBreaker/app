    ...
    <div [ngSwitch]="selection.value">
      <div *ngSwitchCase="'input'">
        <div class="toolbar" role="banner">
          ...
          />
          <span>Enter items to save</span>
          <div class="spacer"></div>
          <a aria-label="Twitter" target="_blank" rel="noopener" href="" title="Twitter">
          ...
          <a aria-label="YouTube" target="_blank" rel="noopener" href="" title="YouTube">
        ...
        <div class="visual-content" role="main">
      ...
      <div *ngSwitchDefault>
        ...
        <div class="content" role="main">
          ...
          <div class="card highlight-card card-small">
            ...
            <span>App is currently active</span>
          ...
          <div class="card-container">
            ...
            <a class="card" target="_blank" rel="noopener" href="https://github.com/angular/angular-cli">
              ...
              <span>Get Angular</span>
              <svg class="material-icons" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>
            </a>

            <a class="card" target="_blank" rel="noopener" href="https://github.com/DynamicProdBreaker/app/discussions">
              <svg class="material-icons" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M13.5.67s.74 2.65.74 4.8c0 2.06-1.35 3.73-3.41 3.73-2.07 0-3.63-1.67-3.63-3.73l.03-.36C5.21 7.51 4 10.62 4 14c0 4.42 3.58 8 8 8s8-3.58 8-8C20 8.61 17.41 3.8 13.5.67zM11.71 19c-1.78 0-3.22-1.4-3.22-3.14 0-1.62 1.05-2.76 2.81-3.12 1.77-.36 3.6-1.21 4.62-2.58.39 1.29.59 2.65.59 4.04 0 2.65-2.15 4.8-4.8 4.8z"/></svg>
              <span>Discussions</span>
              <svg class="material-icons" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>
            </a>

            <a class="card" target="_blank" rel="noopener" href="https://github.com/DynamicProdBreaker/app">
          ...
          <!-- App Options -->
          <h2>App Options</h2>
          <p>What would you like App to do for you?</p>

          <div class="card-container">
            <button class="card card-small" (click)="selection.value = 'input'" tabindex="0">
          ...
          <!-- Links -->
          <div class="card-container">
            <a class="circle-link" title="Find a Local Meetup" href="" target="_blank" rel="noopener">
            ...
            <a class="circle-link" title="Join the Conversation on Discord" href="" target="_blank" rel="noopener">
          ...
          <footer>
              Like App?&nbsp;
              <a href="https://github.com/DynamicProdBreaker/app.git" target="_blank" rel="noopener"> Give the GitHub repository a star.
                <div class="github-star-badge">
                    <svg class="material-icons" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>
                  Star
                </div>
              </a>
              <a href="https://github.com/DynamicProdBreaker/app.git" target="_blank" rel="noopener">
